...
public class PanelSplitor {
    ...
    public static JSplitPane addSplitor(ProjectTree projectPanel, DynamicTree treePanel, GraphWindow graphWindow,
                                  Console console, Variable scenarioVariable, Constraint scenarioConstraint, JTabbedPane tabbedPane) {
