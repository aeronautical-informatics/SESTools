...
public class JtreeToGraph {
    ...
    public void createGraph(JInternalFrame frame) {
        ...
        aspect.put(mxConstants.STYLE_IMAGE,
                PESEditor.class.getClassLoader().getResource("images/aspect.png"));
        ...
        if (ssdFileGraph.exists()) {
            ...
            try {
                ...
                Document xml = mxXmlUtils.parseXml(mxUtils.readFile(
                        PESEditor.fileLocation + "/" + PESEditor.projName + "/" + projectFileNameGraph
                        + "Graph.xml"));
                ...
                if (e.getButton() == MouseEvent.BUTTON3) {
                    ...
                    if (position != null) {
                        GraphCellPopUpPruning graphCellPopup =
                                new GraphCellPopUpPruning(e.getX(), e.getY(), position);
                        if (e.isPopupTrigger()) {
    ...
    public void rootToEndVariableAddition(mxCell varCell) {
        ...
        if (varCell.isVertex()) {
            ...
            nodesToSelectedNode =
                    new HashSet<String>(Arrays.asList(nodesToSelectedNode)).toArray(new String[0]);
    ...
    public void addVariableFromGraphPopup(Object pos) {
        ...
        int option = JOptionPane
                .showConfirmDialog(PESEditor.framew, message, "Please Enter", JOptionPane.OK_CANCEL_OPTION,
    ...
    public void deleteVariableFromGraphPopup(Object pos) {
        ...
        int option = JOptionPane
                .showConfirmDialog(PESEditor.framew, message, "Please Select", JOptionPane.OK_CANCEL_OPTION,
                        JOptionPane.PLAIN_MESSAGE);
    ...
    public void graphToXML() {
        ...
        try {
            saveToXMLFile(calendarDOMDoc,
                    PESEditor.fileLocation + "/" + PESEditor.projName + "/graphxml.xml");
    ...
    public void xmlOutputForXSD() {
        ...
        try {
            f0 = new PrintWriter(
                    new FileWriter(PESEditor.fileLocation + "/" + PESEditor.projName + "/xmlforxsd.xml"));
        } catch (IOException e1) {
            e1.printStackTrace();
        }
    ...
    public void addNodeFromGraphPopup(String node, int x, int y) {
        ...
        String variableName = JOptionPane
                .showInputDialog(PESEditor.framew, "Node Name:", "New Node", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void renameCell(Object pos) {
        ...
        if (cell.getId().equals("rootnode")) {
            ...
            String newName = JOptionPane
                    .showInputDialog(PESEditor.framew, "New Name", "Rename Node", JOptionPane.PLAIN_MESSAGE);
    ...
    public void openExistingProject(String filename, String oldProjectTreeProjectName) {
        ...
        ssdFileGraph =
                new File(PESEditor.fileLocation + "/" + PESEditor.projName + "/" + filename + "Graph.xml");
        ...
        if (ssdFileGraph.exists()) {
            ...
            try {
                ...
                Document xml = mxXmlUtils.parseXml(mxUtils.readFile(
                        PESEditor.fileLocation + "/" + PESEditor.projName + "/" + filename + "Graph.xml"));
                mxCodec codec = new mxCodec(xml);
                codec.decode(xml.getDocumentElement(), graph.getModel());
                parent = graph.getDefaultParent();
...
//		a1++;
        ...
        int option = JOptionPane
                .showConfirmDialog(PESEditor.framew, pruneOptions, "Please Choose from Options",
    ...
    public void changeLeftTreeNodeIconDuringOpning(TreePath targateNodePath) {
        ...
        PESEditor.treePanel.tree.setCellRenderer(new DefaultTreeCellRenderer() {
            ...
            final Icon pruned = new ImageIcon(PESEditor.class.getClassLoader().getResource("images/en.png"));
            final Icon havetoprune =
                    new ImageIcon(PESEditor.class.getClassLoader().getResource("images/enPrune.png"));
            final Icon entityIcon =
                    new ImageIcon(PESEditor.class.getClassLoader().getResource("images/en.png"));
            final Icon specIcon =
                    new ImageIcon(PESEditor.class.getClassLoader().getResource("images/sp.png"));
            final Icon maspIcon =
                    new ImageIcon(PESEditor.class.getClassLoader().getResource("images/ma.png"));
            final Icon aspIcon =
                    new ImageIcon(PESEditor.class.getClassLoader().getResource("images/as16.png")); // as
