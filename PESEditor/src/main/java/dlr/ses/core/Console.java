 ...
 * <p>
 * Creates an console like window and during execution shows all the outputs and
 * errors here. Also it takes some input as a command and performs accordingly.
 * </p>
 * 
				...
				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
					...
					try {
						...
						if (text.startsWith(">>add")) {
							...
							PESEditor.jtreeTograph.addNodeFromConsole(text);
