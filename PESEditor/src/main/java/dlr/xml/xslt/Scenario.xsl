                                ...
                                <object class="2">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <properties>
                                                <xsl:for-each
                                                        select="//entity/aspect/entity[not(@name='WaypointParameters') and not(@name='PlannedState')]/var">
                                                    <tr>
                                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <waypoints>
                                                ...
                                                <xsl:variable name="numWaypoints"
                                                              select="count(//entity[@name='Waypoint_'])"/>
                                                <xsl:for-each select=".">
                                                    <xsl:for-each
                                                            select="//entity/aspect/entity[(@name='WaypointParameters')]/var">
                                                ...
                                                <waypoint>
                                                    ...
                                                    <properties>
                                                        ...
                                                        <xsl:for-each
                                                                select="//entity/aspect/entity[(@name='PlannedState')]/var">
                                                            <tr>
                                                                <td>
                                                                    <xsl:variable name="vTransfers" select="@name"/>
                                                                    <xsl:variable name="varDefault" select="@default"/>
